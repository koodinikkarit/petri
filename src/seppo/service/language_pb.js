...
goog.exportSymbol('proto.SeppoService.SearchLanguagesResponse', null, global);
 ...
 * @constructor
 */
proto.SeppoService.SearchLanguagesResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SeppoService.SearchLanguagesResponse.repeatedFields_, null);
};
goog.inherits(proto.SeppoService.SearchLanguagesResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SeppoService.SearchLanguagesResponse.displayName = 'proto.SeppoService.SearchLanguagesResponse';
}
/**
 ...
 * @const
 */
proto.SeppoService.SearchLanguagesResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.SeppoService.SearchLanguagesResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.SeppoService.SearchLanguagesResponse.toObject(opt_includeInstance, this);
};
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SeppoService.SearchLanguagesResponse}
 */
proto.SeppoService.SearchLanguagesResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SeppoService.SearchLanguagesResponse;
  return proto.SeppoService.SearchLanguagesResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SeppoService.SearchLanguagesResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SeppoService.SearchLanguagesResponse}
 */
proto.SeppoService.SearchLanguagesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SeppoService.SearchLanguagesResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SeppoService.SearchLanguagesResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
...
proto.SeppoService.SearchLanguagesResponse.prototype.setLanguagesList = function(value) {
 ...
 * @return {!proto.SeppoService.Language}
 */
proto.SeppoService.SearchLanguagesResponse.prototype.addLanguages = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.SeppoService.Language, opt_index);
};


proto.SeppoService.SearchLanguagesResponse.prototype.clearLanguagesList = function() {
 ...
 * @return {number}
 */
proto.SeppoService.SearchLanguagesResponse.prototype.getMaxlanguages = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {number} value */
proto.SeppoService.SearchLanguagesResponse.prototype.setMaxlanguages = function(value) {
  jspb.Message.setField(this, 2, value);
};
