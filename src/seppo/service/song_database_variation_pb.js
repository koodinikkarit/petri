...
goog.exportSymbol('proto.SeppoService.FetchVariationsBySongDatabaseIdRequest', null, global);
goog.exportSymbol('proto.SeppoService.FetchVariationsBySongDatabaseIdResponse', null, global);
...
goog.exportSymbol('proto.SeppoService.SongDatabaseVariations', null, global);
 ...
 * @constructor
 */
proto.SeppoService.SongDatabaseVariations = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SeppoService.SongDatabaseVariations.repeatedFields_, null);
};
goog.inherits(proto.SeppoService.SongDatabaseVariations, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SeppoService.SongDatabaseVariations.displayName = 'proto.SeppoService.SongDatabaseVariations';
}
/**
 ...
 * @const
 */
proto.SeppoService.SongDatabaseVariations.repeatedFields_ = [2];
 ...
 * @return {!Object}
 */
proto.SeppoService.SongDatabaseVariations.prototype.toObject = function(opt_includeInstance) {
  return proto.SeppoService.SongDatabaseVariations.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SeppoService.SongDatabaseVariations} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SeppoService.SongDatabaseVariations.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SeppoService.SongDatabaseVariations}
 */
proto.SeppoService.SongDatabaseVariations.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SeppoService.SongDatabaseVariations;
  return proto.SeppoService.SongDatabaseVariations.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SeppoService.SongDatabaseVariations} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SeppoService.SongDatabaseVariations}
 */
proto.SeppoService.SongDatabaseVariations.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SeppoService.SongDatabaseVariations.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SeppoService.SongDatabaseVariations.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SeppoService.SongDatabaseVariations} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SeppoService.SongDatabaseVariations.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSongdatabaseid();
  if (f !== 0) {
    writer.writeUint32(
 ...
 * @return {number}
 */
proto.SeppoService.SongDatabaseVariations.prototype.getSongdatabaseid = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.SeppoService.SongDatabaseVariations.prototype.setSongdatabaseid = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 */
proto.SeppoService.SongDatabaseVariations.prototype.getVariationsList = function() {
...
proto.SeppoService.SongDatabaseVariations.prototype.setVariationsList = function(value) {
 ...
 */
proto.SeppoService.SongDatabaseVariations.prototype.addVariations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.SeppoService.Variation, opt_index);
};


proto.SeppoService.SongDatabaseVariations.prototype.clearVariationsList = function() {
 ...
 * @constructor
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.repeatedFields_, null);
};
goog.inherits(proto.SeppoService.FetchVariationsBySongDatabaseIdRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.displayName = 'proto.SeppoService.FetchVariationsBySongDatabaseIdRequest';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdRequest} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SeppoService.FetchVariationsBySongDatabaseIdRequest}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SeppoService.FetchVariationsBySongDatabaseIdRequest;
  return proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SeppoService.FetchVariationsBySongDatabaseIdRequest}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdRequest} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @return {!Array.<number>}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.getSongdatabaseidsList = function() {
  return /** @type {!Array.<number>} */ (jspb.Message.getField(this, 1));
};


/** @param {!Array.<number>} value */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.setSongdatabaseidsList = function(value) {
  jspb.Message.setField(this, 1, value || []);
};
 ...
 * @param {number=} opt_index
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.addSongdatabaseids = function(value, opt_index) {
  jspb.Message.addToRepeatedField(this, 1, value, opt_index);
};


proto.SeppoService.FetchVariationsBySongDatabaseIdRequest.prototype.clearSongdatabaseidsList = function() {
 ...
 * @constructor
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.repeatedFields_, null);
};
goog.inherits(proto.SeppoService.FetchVariationsBySongDatabaseIdResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.displayName = 'proto.SeppoService.FetchVariationsBySongDatabaseIdResponse';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.repeatedFields_ = [1];
 ...
 * @return {!Object}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdResponse} msg The msg instance to transform.
 * @return {!Object}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    songdatabasevariationsList: jspb.Message.toObjectList(msg.getSongdatabasevariationsList(),
    proto.SeppoService.SongDatabaseVariations.toObject, includeInstance)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.SeppoService.FetchVariationsBySongDatabaseIdResponse}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.SeppoService.FetchVariationsBySongDatabaseIdResponse;
  return proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.SeppoService.FetchVariationsBySongDatabaseIdResponse}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    switch (field) {
    case 1:
      var value = new proto.SeppoService.SongDatabaseVariations;
      reader.readMessage(value,proto.SeppoService.SongDatabaseVariations.deserializeBinaryFromReader);
      msg.addSongdatabasevariations(value);
      break;
    default:
      reader.skipField();
      break;
 ...
 * @return {!Uint8Array}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.SeppoService.FetchVariationsBySongDatabaseIdResponse} message
 * @param {!jspb.BinaryWriter} writer
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getSongdatabasevariationsList();
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.SeppoService.SongDatabaseVariations.serializeBinaryToWriter
    );
  }
};
 ...
 * If you change this array by adding, removing or replacing elements, or if you
 * replace the array itself, then you must call the setter to update it.
 * @return {!Array.<!proto.SeppoService.SongDatabaseVariations>}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.getSongdatabasevariationsList = function() {
  return /** @type{!Array.<!proto.SeppoService.SongDatabaseVariations>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.SeppoService.SongDatabaseVariations, 1));
};


/** @param {!Array.<!proto.SeppoService.SongDatabaseVariations>} value */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.setSongdatabasevariationsList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};


/**
 * @param {!proto.SeppoService.SongDatabaseVariations=} opt_value
 * @param {number=} opt_index
 * @return {!proto.SeppoService.SongDatabaseVariations}
 */
proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.addSongdatabasevariations = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.SeppoService.SongDatabaseVariations, opt_index);
};


proto.SeppoService.FetchVariationsBySongDatabaseIdResponse.prototype.clearSongdatabasevariationsList = function() {
  this.setSongdatabasevariationsList([]);
};
